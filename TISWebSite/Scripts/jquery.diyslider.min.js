        ...
        if (typeof t == "object" || !t) {
            var r = {
                ...
                move: function (t) {
                    ...
                    this.options.loop && i !== !1 && i > this.slidesCount - (this.options.display - 1) && (i = 1), this.options.loop && i !== !1 && i <= 0 && (i = this.slidesCount - (this.options.display - 1));
                    if (i !== !1 && i > 0 && i <= this.slidesCount - (this.options.display - 1) && i != this.currentSlide) {
                        var s = e(this.slides[this.currentSlide - 1]);
                        this.currentSlide = i, s.removeClass("active").addClass("last-active");
                        var o = e(this.slides[i - 1]).addClass("next-active"),
                            u = e.proxy(function () {
                                s.removeClass("last-active"), o.removeClass("next-active").addClass("active"), this.slider.trigger("moved.diyslider", [o, i, !0])
                            }, this);
                        this.slider.trigger("moving.diyslider", [o, i, !0]), r ? (this.slidesContainer.css(this.getSlidesContainerPosition()), u()) : this.slidesContainer.animate(this.getSlidesContainerPosition(), {
                            queue: !1,
                            duration: this.options.animationDuration,
                            easing: this.options.animationEasing,
                            complete: u
                        })
                    } else i == this.currentSlide && (this.slider.trigger("moving.diyslider", [e(this.slides[i - 1]), i, !1]), this.slider.trigger("moved.diyslider", [e(this.slides[i - 1]), i, !1]))
                },
                resize: function (t) {
                    var r = t[0],
                        i = t[1];
                    return this.dimensions.w = r, this.dimensions.h = i, this.slider.css({
                    ...
                    }), this.slider.trigger("resized.diyslider", [this.dimensions]), n
                },
                updateOptions: function (t) {
                    ...
                    return e.each(r, e.proxy(function (e, t) {
                        if (this.options.hasOwnProperty(e) && this.options[e] != t) {
                            this.options[e] = t;
                            if (e == "width" || e == "height" || e == "animationAxis" || e == "display") i = !0
                        }
                    }, this)), i && this.resize([this.options.width, this.options.height]), n
                },
                setStyles: function () {
                    this.slider.css({
                        position: "relative",
            ...
            return r.slidesCount = r.slides.length, r.slidesCount ? e(r.slides[0]).addClass("active") : typeof console != "undefined" && console.warn("No slides found for DIYslider"), r.setStyles(), r.resize([r.options.width, r.options.height]), r.move([r.options.start, !0]), r.slider.data("diyslider", r), n
        }
        if (typeof n.data("diyslider")[t] == "function") return n.data("diyslider")[t](Array.prototype.slice.call(arguments, 1))
    }
})(jQuery)